...
define root view entity YI_ASIM0050N
  as select from zasimt0050n as _Asim0050n
    ...
    composition [1..*] of YI_ASIM0060N as _Item
...
//      ]
      ...
      _Asim0050n.crtnm                                   as Crtnm,
      _Asim0050n.crtbu                                   as Crtbu,

      @Semantics.systemDateTime.createdAt: true
      @EndUserText.label: 'Create Date'
      _Asim0050n.crtdt                                   as Crtdt,

      _Asim0050n.crttm                                   as Crttm,
      _Asim0050n.chgnm                                   as Chgnm,
      _Asim0050n.chgbu                                   as Chgbu,

      @ObjectModel.filter.enabled: false
      @EndUserText.label: 'Change Date'
      _Asim0050n.chgdt                                   as Chgdt,

      _Asim0050n.chgtm                                   as Chgtm,
