...
define root view entity YI_ASIM0052N as 

select 
  from YI_ASIM0040N as _Asim0040n
  join YI_ASIM0030N as _Asim0030n on _Asim0030n.Uuid = _Asim0040n.ParentUUID
  left outer join YI_ASIM0050N_CREATED_IVGB as _ivgb on  _Asim0040n.Reqno = _ivgb.Reqno
                                                     and _Asim0040n.Reqyr = _ivgb.Reqyr
...
where _Asim0030n.Loekz  = ''
  and _Asim0040n.Chk_iv is null
  and case when _ivgb.Ivgb is null or _ivgb.Ivgb = 'B' then 'O' else 'X' end = 'O'
