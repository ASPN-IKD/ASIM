@EndUserText.label: '지급처 도움말 뷰'
@AccessControl.authorizationCheck: #NOT_REQUIRED
define view entity ZASIMV_IVLIF as select from I_Supplier

 association [0..*] to I_SupplierPurchasingOrg        as _SupplierPurchasingOrg        on  $projection.Ivlif = _SupplierPurchasingOrg.Supplier
 association [0..*] to I_Supplier        as _Text        on  $projection.Ivlif = _Text.Supplier
 
{   
    
    @ObjectModel.text.element: ['Ivlift']
    @EndUserText.label: '공급업체'
    key Supplier as Ivlif,
