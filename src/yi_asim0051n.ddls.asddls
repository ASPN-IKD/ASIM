...
@EndUserText.label: '수입I/V 생성가능 정보 인터페이스 뷰'
define root view entity YI_ASIM0051N as 

select 
  from YI_ASIM0020N as _Asim0020n
  join YI_ASIM0010N as _Asim0010n on _Asim0010n.Uuid  = _Asim0020n.ParentUUID
  left outer join YI_ASIM0050N_CREATED_IVGB as _ivgb on  _Asim0020n.Reqno = _ivgb.Reqno
                                                     and _Asim0020n.Reqyr = _ivgb.Reqyr

{
  ...
  key _Asim0020n.Uuid           as Uuid,
      ...
      _Asim0010n.Lifre          as Ivlif,

      @EndUserText.label: '지급처명'
      _Asim0010n.Lifret         as Ivlift,
      ...
      @Semantics.quantity.unitOfMeasure: 'Reqms'
      //분할 생성 시, 
      case when _Asim0020n.Modmg_iv > 0 then _Asim0020n.Modmg_iv
      ...
      else case when _Asim0020n.Modmg_iv > 0 then
           cast( _Asim0020n.Modmg_iv * ( _Asim0020n.Modpr / _Asim0020n.Peinh ) as abap.dec(20,2))
...
where _Asim0010n.Loekz = ''
  and _Asim0020n.Chk_iv is null
  and case when _ivgb.Ivgb is null or _ivgb.Ivgb = 'A' then 'O' else 'X' end = 'O'
