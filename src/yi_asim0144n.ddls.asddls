...
@EndUserText.label: 'CC - EX 아이템 참조 뷰'
define root view entity YI_ASIM0144N
  as select from YI_ASIM0080N
  association [1..1] to YI_ASIM0070N as _Head on _Head.Uuid = $projection.ParentUUID
