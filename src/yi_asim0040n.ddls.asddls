...
define root view entity YI_ASIM0040N
  as select from    zasimt0040n
    left outer join YI_ASIM0050N_CREATED_FINAL1 as _created_iv  on  zasimt0040n.blino = _created_iv.Blino
                                                                                   ...
                                                                                   and _PurOrdAccountAssignment.AccountAssignmentNumber = '01'
{
  ...
  key      zasimt0040n.uuid                             as Uuid,
           ...
           zasimt0040n.parentuuid                       as ParentUUID,
           ...
           case when _created_iv.chk = '' or _created_iv.chk = 'X' then cast(_created_iv.Modmg as abap.quan(13,3))
                else zasimt0040n.blmng end              as Modmg_iv,
           ...
           case when _created_ecc.chk = '' or _created_ecc.chk = 'X' then cast(_created_ecc.Modmg as abap.quan(13,3))
                else zasimt0040n.blmng end              as Modmg_ecc,
           ...
           case when _created_cc.chk = '' or _created_cc.chk = 'X' then cast(_created_cc.Modmg as abap.quan(13,3))
                else zasimt0040n.blmng end              as Modmg_cc,
