...
define root view entity YI_ASIM0051N
  as select from YI_ASIM0010N as _Asim0010n
  association [1..*] to YI_ASIM0020N as _Asim0020n on  $projection.Uuid    = _Asim0020n.ParentUUID
                                                   and _Asim0020n.Modmg_iv > 0
{
      @ObjectModel.filter.enabled: false
  key _Asim0010n.Uuid                                                                        as Uuid,

      @ObjectModel.filter.enabled: false
  key _Asim0020n.Uuid                                                                        as Uuidi,

      @EndUserText.label: '계약연도'
      _Asim0020n.Reqyr                                                                       as Reqyr,

      @Consumption.valueHelpDefinition: [{entity: {name: 'ZASIMV_REQNO', element: 'Reqno' }}]
      @EndUserText.label: '계약내부번호'
      _Asim0020n.Reqno                                                                       as Reqno,
      ...
      @Semantics.amount.currencyCode: 'Waers'
      cast( _Asim0020n.Modmg_iv * ( _Asim0020n.Modpr / _Asim0020n.Peinh ) as abap.dec(20,2)) as Reqwr,
