@EndUserText.label: 'BL - EX 아이템 참조 뷰'
@AccessControl.authorizationCheck: #NOT_REQUIRED
define root view entity YI_ASIM0143N
  as select from YI_ASIM0040N
  association [1..1] to YI_ASIM0030N      as _Head            on  _Head.Uuid = $projection.ParentUUID
