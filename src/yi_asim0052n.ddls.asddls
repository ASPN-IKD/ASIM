...
define root view entity YI_ASIM0052N
                                                   ...
                                                   and _Asim0040n.Modmg_iv > 0
{
  ...
  key _Asim0040n.ParentUUID                                                                   as Parentuuid,
      ...
      @Semantics.amount.currencyCode: 'Waers'
      cast( _Asim0040n.Modmg_iv * ( _Asim0040n.Modpr / _Asim0040n.Blpnh ) as abap.dec(20,2) ) as Blmwr,
