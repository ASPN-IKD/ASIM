...
define root view entity YI_ASIM0900N
  as
  ...
  select from YI_ASIM0130N as _exah
    ...
    join      YI_ASIM0001N as _curr   on  _exah.WaersFees =    _curr.Zvalu1
                                      and _curr.Zcode     like '%CURR'
{
  ...
  key _exai.Feenp                   as Feenp,
      ...
      case when _exah.Zvalu3 = 'S' then _exai.NetwrFees * -1
           else _exai.NetwrFees
           end                      as Netwr,
      @Semantics.amount.currencyCode : 'Waers'
      @EndUserText.label: '세액'
      case when _exah.Zvalu3 = 'S' then _exai.WmwstFees * -1
           else _exai.WmwstFees
           end                      as Wmwst,
      @Semantics.amount.currencyCode : 'Waers'
      @EndUserText.label: '총금액'
      case when _exah.Zvalu3 = 'S' then cast( cast(_exai.NetwrFees as abap.dec(20,2)) + cast(_exai.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) * -1
           else cast( cast(_exai.NetwrFees as abap.dec(20,2)) + cast(_exai.WmwstFees as abap.dec(20,2)) as abap.dec(20,2))
           end                      as Rmmwr,
      ...
      case when _exah.Zvalu3 = 'S' then case when _exai.WaersFees <> 'KRW' then cast( cast(_exai.NetwrFees as abap.dec(20,2)) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exai.NetwrFees as abap.dec(20,2)) end * -1
           else case when _exai.WaersFees <> 'KRW' then cast( cast(_exai.NetwrFees as abap.dec(20,2)) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exai.NetwrFees as abap.dec(20,2)) end
           end                      as Netwrk,

      @Semantics.amount.currencyCode : 'Waersk'
      @EndUserText.label: '세액(KRW)'
      case when _exah.Zvalu3 = 'S' then case when _exai.WaersFees <> 'KRW' then cast( cast(_exai.WmwstFees as abap.dec(20,2)) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exai.WmwstFees as abap.dec(20,2)) end * -1
           else case when _exai.WaersFees <> 'KRW' then cast( cast(_exai.WmwstFees as abap.dec(20,2)) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exai.WmwstFees as abap.dec(20,2)) end
           end                      as Wmwstk,

      @Semantics.amount.currencyCode : 'Waersk'
      @EndUserText.label: '총금액(KRW)'
      case when _exah.Zvalu3 = 'S' then case when _exai.WaersFees <> 'KRW' then cast( ( cast(_exai.NetwrFees as abap.dec(20,2)) + cast(_exai.WmwstFees as abap.dec(20,2)) ) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exai.NetwrFees as abap.dec(20,2))
                                             + cast(_exai.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end * -1
           else case when _exai.WaersFees <> 'KRW' then cast( ( cast(_exai.NetwrFees as abap.dec(20,2)) + cast(_exai.WmwstFees as abap.dec(20,2)) ) * _exah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exai.NetwrFees as abap.dec(20,2))
                                             + cast(_exai.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end
           end                      as Rmmwrk,
...
select from YI_ASIM0130N as _exbh
  ...
  join      YI_ASIM0001N as _curr on  _exbh.WaersFees =    _curr.Zvalu1
                                  and _curr.Zcode     like '%CURR'
{
  ...
  key _exbi.Feenp                   as Feenp,
      ...
      case when _exbh.Zvalu3 = 'S' then _exbi.NetwrFees * -1
           else _exbi.NetwrFees
           end                      as Netwr,
      case when _exbh.Zvalu3 = 'S' then _exbi.WmwstFees * -1
           else _exbi.WmwstFees
           end                      as Wmwst,
      case when _exbh.Zvalu3 = 'S' then cast( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) * -1
           else cast( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2))
           end                      as Rmmwr,
      cast('KRW' as abap.cuky( 5 )) as Waersk,
      case when _exbh.Zvalu3 = 'S' then case when _exbi.WaersFees <> 'KRW' then cast( cast(_exbi.NetwrFees as abap.dec(20,2)) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exbi.NetwrFees as abap.dec(20,2)) end * -1
           else case when _exbi.WaersFees <> 'KRW' then cast( cast(_exbi.NetwrFees as abap.dec(20,2)) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exbi.NetwrFees as abap.dec(20,2)) end
           end                      as Netwrk,
      case when _exbh.Zvalu3 = 'S' then case when _exbi.WaersFees <> 'KRW' then cast( cast(_exbi.WmwstFees as abap.dec(20,2)) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exbi.WmwstFees as abap.dec(20,2)) end * -1
           else case when _exbi.WaersFees <> 'KRW' then cast( cast(_exbi.WmwstFees as abap.dec(20,2)) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exbi.WmwstFees as abap.dec(20,2)) end
           end                      as Wmwstk,
      case when _exbh.Zvalu3 = 'S' then case when _exbi.WaersFees <> 'KRW' then cast( ( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) ) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end * -1
           else case when _exbi.WaersFees <> 'KRW' then cast( ( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) ) * _exbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exbi.NetwrFees as abap.dec(20,2)) + cast(_exbi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end
           end                      as Rmmwrk,
      cast(0 as abap.dec(20,0))     as DmbtrGr,
      cast(0 as abap.dec(20,0))     as DmbtrGrir,
      cast(0 as abap.dec(20,0))     as DmbtrTot,
...
select from YI_ASIM0130N as _exch
  ...
  join      YI_ASIM0001N as _curr on  _exch.WaersFees =    _curr.Zvalu1
                                  and _curr.Zcode     like '%CURR'
{
  ...
  key _exci.Feenp                   as Feenp,
      ...
      case when _exch.Zvalu3 = 'S' then _exci.NetwrFees * -1
           else _exci.NetwrFees
           end                      as Netwr,
      case when _exch.Zvalu3 = 'S' then _exci.WmwstFees * -1
           else _exci.WmwstFees
           end                      as Wmwst,
      case when _exch.Zvalu3 = 'S' then cast( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) * -1
           else cast( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) as abap.dec(20,2))
           end                      as Rmmwr,
      cast('KRW' as abap.cuky( 5 )) as Waersk,
      case when _exch.Zvalu3 = 'S' then case when _exci.WaersFees <> 'KRW' then cast( cast(_exci.NetwrFees as abap.dec(20,2)) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exci.NetwrFees as abap.dec(20,2)) end * -1
           else case when _exci.WaersFees <> 'KRW' then cast( cast(_exci.NetwrFees as abap.dec(20,2)) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exci.NetwrFees as abap.dec(20,2)) end
           end                      as Netwrk,
      case when _exch.Zvalu3 = 'S' then case when _exci.WaersFees <> 'KRW' then cast( cast(_exci.WmwstFees as abap.dec(20,2)) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exci.WmwstFees as abap.dec(20,2)) end * -1
           else case when _exci.WaersFees <> 'KRW' then cast( cast(_exci.WmwstFees as abap.dec(20,2)) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exci.WmwstFees as abap.dec(20,2)) end
           end                      as Wmwstk,
      case when _exch.Zvalu3 = 'S' then case when _exci.WaersFees <> 'KRW' then cast( ( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) ) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end * -1
           else case when _exci.WaersFees <> 'KRW' then cast( ( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) ) * _exch.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exci.NetwrFees as abap.dec(20,2)) + cast(_exci.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end
           end                      as Rmmwrk,
      cast(0 as abap.dec(20,0))     as DmbtrGr,
      cast(0 as abap.dec(20,0))     as DmbtrGrir,
      cast(0 as abap.dec(20,0))     as DmbtrTot,
...
select from YI_ASIM0130N as _exdh
  ...
  join      YI_ASIM0001N as _curr on  _exdh.WaersFees =    _curr.Zvalu1
                                  and _curr.Zcode     like '%CURR'
{
  ...
  key _exdi.Feenp                   as Feenp,
      ...
      case when _exdh.Zvalu3 = 'S' then _exdi.NetwrFees * -1
           else _exdi.NetwrFees
           end                      as Netwr,
      case when _exdh.Zvalu3 = 'S' then _exdi.WmwstFees * -1
           else _exdi.WmwstFees
           end                      as Wmwst,
      case when _exdh.Zvalu3 = 'S' then cast( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) * -1
           else cast( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2))
           end                      as Rmmwr,
      cast('KRW' as abap.cuky( 5 )) as Waersk,
      case when _exdh.Zvalu3 = 'S' then case when _exdi.WaersFees <> 'KRW' then cast( cast(_exdi.NetwrFees as abap.dec(20,2)) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exdi.NetwrFees as abap.dec(20,2)) end * -1
           else case when _exdi.WaersFees <> 'KRW' then cast( cast(_exdi.NetwrFees as abap.dec(20,2)) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exdi.NetwrFees as abap.dec(20,2)) end
           end                      as Netwrk,
      case when _exdh.Zvalu3 = 'S' then case when _exdi.WaersFees <> 'KRW' then cast( cast(_exdi.WmwstFees as abap.dec(20,2)) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exdi.WmwstFees as abap.dec(20,2)) end * -1
           else case when _exdi.WaersFees <> 'KRW' then cast( cast(_exdi.WmwstFees as abap.dec(20,2)) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast(_exdi.WmwstFees as abap.dec(20,2)) end
           end                      as Wmwstk,
      case when _exdh.Zvalu3 = 'S' then case when _exdi.WaersFees <> 'KRW' then cast( ( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) ) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end * -1
           else case when _exdi.WaersFees <> 'KRW' then cast( ( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) ) * _exdh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
                                             else cast( cast(_exdi.NetwrFees as abap.dec(20,2)) + cast(_exdi.WmwstFees as abap.dec(20,2)) as abap.dec(20,2)) end
           end                      as Rmmwrk,
      cast(0 as abap.dec(20,0))     as DmbtrGr,
      cast(0 as abap.dec(20,0))     as DmbtrGrir,
      cast(0 as abap.dec(20,0))     as DmbtrTot,
...
select from YI_ASIM0050N as _ivah
  ...
  join      YI_ASIM0001N as _curr   on  _ivah.Ivwae =    _curr.Zvalu1
                                    and _curr.Zcode like '%CURR'
{
  ...
  key _ivai.Buzei                                                                                        as Feenp,
      ...
      cast('KRW' as abap.cuky( 5 ))                                                                      as Waersk,
      case when _ivai.Waers <> 'KRW' then cast( cast(_ivai.Ivwra as abap.dec(20,2)) * _ivah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast(_ivai.Ivwra as abap.dec(20,2)) end                                                  as Netwrk,
      case when _ivai.Waers <> 'KRW' then cast( cast(_ivai.Ivwmw as abap.dec(20,2)) * _ivah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast(_ivai.Ivwmw as abap.dec(20,2)) end                                                  as Wmwstk,
      case when _ivai.Waers <> 'KRW' then cast( ( cast(_ivai.Ivwra as abap.dec(20,2)) + cast(_ivai.Ivwmw as abap.dec(20,2)) ) * _ivah.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast( cast(_ivai.Ivwra as abap.dec(20,2))
           + cast(_ivai.Ivwmw as abap.dec(20,2)) as abap.dec(20,2))
           end                                                                                           as Rmmwrk,
      //      case when _ivai.Waers <> 'KRW' then cast( cast(_ivai.Ivwra as abap.dec(20,2)) * _ivah.Kursf as abap.dec(20,0))
      //           else cast(_ivai.Ivwra as abap.dec(20,0)) end                                                  as Netwrk,
      //      case when _ivai.Waers <> 'KRW' then cast( cast(_ivai.Ivwmw as abap.dec(20,2)) * _ivah.Kursf as abap.dec(20,0))
      //           else cast(_ivai.Ivwmw as abap.dec(20,0)) end                                                  as Wmwstk,
      //      case when _ivai.Waers <> 'KRW' then cast( ( cast(_ivai.Ivwra as abap.dec(20,2)) + cast(_ivai.Ivwmw as abap.dec(20,2)) ) * _ivah.Kursf  as abap.dec(20,0))
      //           else cast( cast(_ivai.Ivwra as abap.dec(20,2))
...
select from YI_ASIM0050N as _ivbh
  ...
  join      YI_ASIM0001N as _curr  on  _ivbh.Ivwae =    _curr.Zvalu1
                                   and _curr.Zcode like '%CURR'
{
  ...
  key _ivbi.Buzei                                                                                        as Feenp,
      ...
      cast('KRW' as abap.cuky( 5 ))                                                                      as Waersk,
      case when _ivbi.Waers <> 'KRW' then cast( cast(_ivbi.Ivwra as abap.dec(20,2)) * _ivbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast(_ivbi.Ivwra as abap.dec(20,2)) end                                                  as Netwrk,
      case when _ivbi.Waers <> 'KRW' then cast( cast(_ivbi.Ivwmw as abap.dec(20,2)) * _ivbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast(_ivbi.Ivwmw as abap.dec(20,2)) end                                                  as Wmwstk,
      case when _ivbi.Waers <> 'KRW' then cast( ( cast(_ivbi.Ivwra as abap.dec(20,2)) + cast(_ivbi.Ivwmw as abap.dec(20,2)) ) * _ivbh.Kursf * cast(_curr.Zvalu4 as abap.dec(5,0)) / cast(_curr.Zvalu3 as abap.dec(5,0)) as abap.dec(20,2))
           else cast( cast(_ivbi.Ivwra as abap.dec(20,2))
           + cast(_ivbi.Ivwmw as abap.dec(20,2)) as abap.dec(20,2))
           end                                                                                           as Rmmwrk,
      cast(0 as abap.dec(20,0))                                                                          as DmbtrGr,
      cast(0 as abap.dec(20,0))                                                                          as DmbtrGrir,
      cast(0 as abap.dec(20,0))                                                                          as DmbtrTot,
...

{
  ...
  key cast( concat('00',_gri.Zeile) as abap.numc(6))                                                                                   as Feenp,
      ...
      cast('KRW' as abap.cuky( 5 ))                                                                                                    as Waersk,
      cast(0 as abap.dec(20,2))                                                                                                        as Netwrk,
      cast(0 as abap.dec(20,2))                                                                                                        as Wmwstk,
      cast(0 as abap.dec(20,2))                                                                                                        as Rmmwrk,
