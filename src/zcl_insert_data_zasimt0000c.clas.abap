...
******************************수입계약생성(수기)******************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Bukrs|Ekorg|Ekgrp|Lifnr|Ekgrp|Zterm|Inco1|Netwr'.
    ls_data-fieldcre = 'Bukrs|Ekorg|Ekgrp|Lifnr|Ekgrp|Zterm|Inco1'.
    ls_data-fieldupd = 'Lifnr|Inco1'.
    ls_data-fieldnum = 'Bukrs|Ekorg|Ekgrp'.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = 'Lifnr|Inco1'.
    ls_data-roleid = 'IM'.
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Reqno|Lifre|Reqdt|Zcdno3|Reqmu|Colif|Acdat|Zcdno1|Filif|Conrt|Zcdno2|Cont1|Cont2|Zcdno4|Rqche'.
    ls_data-fieldcre = 'Lifre|Reqdt|Zcdno3|Colif|Acdat|Zcdno1|Filif|Conrt|Zcdno2|Cont1|Cont2|Zcdno4|Rqche'.
    ls_data-fieldupd = 'Lifre|Reqdt|Zcdno3|Colif|Acdat|Zcdno1|Filif|Conrt|Zcdno2|Cont1|Cont2|Zcdno4|Rqche'.
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ls_data-fieldcre = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ls_data-fieldupd = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ...
    ls_data-fieldupd = 'Reqmg|Reqms|Reqmg1|Reqms1|Reqnr|Peinh|Reqwr|Waers|Werks|Remak'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = 'Matnr|Werks'.
    ls_data-fieldseq = 'Reqmg|Reqms|Reqmg1|Reqms1|Reqnr|Peinh|Reqwr|Waers|Werks|Remak'.
    ls_data-roleid = 'IM'.
...
******************************수입계약생성(수입계약참조)******************************************
    ...
    ls_data-fieldcre = 'Bukrs|Zterm|Ekorg|Inco1|Ekgrp|Inco2|Lifnr|Remak'.
    ls_data-fieldupd = 'Bukrs|Zterm|Ekorg|Inco1|Ekgrp|Inco2|Lifnr|Remak'.
    ls_data-fieldnum = 'Bukrs|Zterm|Ekorg'.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = 'Bukrs|Zterm|Ekorg|Inco1|Ekgrp|Inco2|Lifnr|Remak'.
    ls_data-roleid = 'IM'.
    ...
    ls_data-fieldcre = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pedat|Rqrsf|Opamt|opwrs|Pdate|Sdate|Edate'.
    ls_data-fieldupd = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ls_data-fieldnum = 'Pterm|Opnum|Oplif'.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
...
********************************수입계약생성(구매오더참조)*************************************************
    ...
    ls_data-fieldupd = 'Reqmg|Reqnr|Peinh|Werks|Remak'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = 'Matnr|Werks'.
    ls_data-fieldseq = 'Reqmg|Reqms|Reqmg1|Reqms1|Reqnr|Peinh|Reqwr|Waers|Werks|Remak'.
...
********************************BL생성*************************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Opwrs|Oedat|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ls_data-fieldcre = ''.
    ls_data-fieldupd = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ...
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = 'Bleno|Rqetd|Brgew|Bldat|Rqeta|Negew|Eccgb|Bldat2|Bletd|Mosno|Blche|Lgnum|Bleta|Blitx'.
    ls_data-roleid = 'BL'.
    ...
    ls_data-fieldcre = 'Matnr|Blmng|Blmns|Blpnh|Blmpr|Waers|Werks|Lgort|Eindt|Kostl|Zdc1_p|Zdc2_p|Hsdat'.
    ls_data-fieldupd = 'Matnr|Blmwr|Blmpr|Werks|Lgort|Eindt|Kostl|Zdc1_p|Zdc1_n|Zdc2_p|Zdc2_n|Hsdat'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = 'Matnr|Blmng|Blmns|Waers|Werks|Eindt|Zdc1_p|Zdc2_p|'.
    ls_data-fieldseq = 'Matnr|Blmwr|Blmpr|Werks|Lgort|Eindt|Kostl|Zdc1_p|Zdc1_n|Zdc2_p|Zdc2_n|Hsdat'.
    ls_data-roleid = 'BL'.
...
********************************IV생성(B/L참조) *************************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Pterm|Opnum|Oplif|Zbd1t|Opbnk|Oedat|Pdate|Pedat|Rqrsf|Opamt|Pdate|Sdate|Edate'.
    ls_data-fieldcre = ''.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Belnr|Ivlif|Pdate|Rmwwr|Invno|Iverm|Zfbdt|Mwskz|Zlsch|Fbedt|Wmwst1|BudatIv|Ivwae|Kursf|Ivamt|Bktxt'.
    ls_data-fieldcre = 'Ivlif|Pdate|Rmwwr|Iverm|Zfbdt|Mwskz|Invno|Zlsch|Wmwst1|BudatIv|Kursf|Bktxt'.
    ls_data-fieldupd = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = ''.
    ...
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = 'Ivmng|Meins|Ivwra|Waers'.
    ls_data-roleid = 'IV'.
...
********************************통관생성(B/L참조)*************************************************
    ...
    ls_data-fieldupd = 'Decno|Cclif|Ccper|Decdt|Ccdat1|Ccdat2|Ccdat|Cclog|Ccmos|Ccamt|Ccwae|Ccrsf|Ccvat1|Ccvat2|Hwbas|Ccltx|Ccamtk|Ccwaek'.
...
********************************통관생성(통관예정참조)*************************************************
    ...
    ls_data-fieldcre = 'Decno|Cclif|Ccper|Decdt|Ccdat1|Ccdat2|Ccdat|Ccmos|Ccamt|Ccwae|Ccrsf|Ccvat1|Ccvat2|Hwbas|Ccltx|Ccamtk|Ccwaek'.
    ls_data-fieldupd = 'Decno|Cclif|Ccper|Decdt|Ccdat1|Ccdat2|Ccdat|Cclog|Ccmos|Ccamt|Ccwae|Ccrsf|Ccvat1|Ccvat2|Hwbas|Ccltx|Ccamtk|Ccwaek'.
    ls_data-fieldnum = 'Egrdt|Eccdt|Ccldt|Cclog|Eccmrn|Ecctrn'.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
...
********************************수입입고*************************************************
  ...
  CATCH cx_uuid_error.
    ...
    ls_data-viewtp = 'G'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Itmno|Matnr|Maktx|Grmng|Grmns|Werks|Werkst|Lgort|Lgortt|Charg|Hsdat|Maxlz|Vfdat'.
    ls_data-fieldcre = 'Grmng|Charg|Hsdat|Maxlz|Lgort'.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = 'Charg|Hsdat'.
    ls_data-fieldseq = ''.
    ls_data-roleid = 'IG'.
...
********************************부대비생성(수입계약참조)*************************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Bukrs|Ekorg|Ekgrp|Lifnr|Lifret|Colift|Cont1|Cont2|Reqdt|Acdat|Zterm|Zcdno3t|Zcdno1t|Zcdno2t|Zcdno4t|Inco1|Inco2|Remak|Conrt'.
    ls_data-fieldcre = ''.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Ptermt|Zbd1t|Pedat|Pdate|Opnum|Oedat|Opdat|Opbnkt|Oplift|Opamt|Opwrs|Sdate|Edate'.
    ls_data-fieldcre = ''.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Feeno|Reqmu|Zcdno|Feegb|Gbno|Lifre_fees|Budat_fees|Zterm_fees|Zlsch|Zfbdt|Fbedt|Ivamt_fees|Waers_fees|Mwskz|Wmwst1_fees|Kursf|Bktxt|Trlif_fees|Zremk'.
    ls_data-fieldcre = 'Zcdno|Lifre_fees|Budat_fees|Zterm_fees|Zlsch|Zfbdt|Ivamt_fees|Mwskz|Wmwst1_fees|Kursf|Bktxt'.
    ls_data-fieldupd = 'Lifre_fees|Budat_fees|Zterm_fees|Zlsch|Zfbdt|Ivamt_fees|Mwskz|Wmwst1_fees|Kursf|Bktxt|Trlif_fees'.
    ...
    ls_data-viewtp = 'G'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Blino|Bliyr|Blinp'.
    ls_data-fieldcre = ''.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
...
********************************부대비생성(B/L참조)*************************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Feeno|Zcdno|Feegb|ZtermFees|Gbno|Mwskz|Zbd1t|Postgb|LifreFees|BudatFees|Kursf|Zterm|Zlsch|Zfbdt|Fbedt|IvamtFees|Wmwst1Fees|Bktxt'.
    ls_data-fieldcre = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Fbedt|Mwskz|Zbd1t|IvamtFees|Wmwst1Fees|Bktxt'.
    ls_data-fieldupd = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Mwskz|Zbd1t|IvamtFees|Wmwst1Fees|Bktxt'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = ''.
    ...
    ls_data-viewtp = 'G'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Blinp|Matnr|Maktx|MengeFees|MeinsFees|NetwrFees|WaersFees|Werks|Werkst|Reqno|Ebeln|Blino|Cclno|Mblnr'.
...
********************************부대비생성(통관 참조)*************************************************
    ...
    ls_data-viewtp = 'B'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Feeno|Zcdno|Feegb|ZtermFees|Gbno|Mwskz|Zbd1t|Postgb|LifreFees|BudatFees|Kursf|Zterm|Zlsch|Zfbdt|Fbedt|IvamtFees|Wmwst1Fees|Bktxt|RmwwrFees|WaersFees'.
    ls_data-fieldcre = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Mwskz|Zbd1t|Fbedt|Wmwst1Fees|Bktxt|RmwwrFees|IvamtFees'.
    ls_data-fieldupd = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Mwskz|Zbd1t|Wmwst1Fees|Bktxt|RmwwrFees'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
    ls_data-fieldseq = ''.
    ...
    ls_data-viewtp = 'G'.
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Feenp|Matnr|Maktx|MengeFees|MeinsFees|NetwrFees|WaersFees|Werks|Werkst|Reqno|Ebeln|Blino|Cclno|Mblnr'.
    ls_data-fieldcre = 'NetwrFees'.
    ls_data-fieldupd = ''.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
...
********************************부대비생성(입고 참조)*************************************************
    ...
    ls_data-usediv = 'Y'.
    ls_data-fieldall = 'Feeno|Zcdno|Feegb|ZtermFees|Gbno|Mwskz|Zbd1t|Postgb|LifreFees|BudatFees|Kursf|Zterm|Zlsch|Zfbdt|Fbedt|IvamtFees|Wmwst1Fees|Bktxt|RmwwrFees|WaersFees'.
    ls_data-fieldcre = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Mwskz|Zbd1t|Wmwst1Fees|Bktxt|RmwwrFees'.
    ls_data-fieldupd = 'Zcdno|LifreFees|BudatFees|Kursf|Zterm|ZtermFees|Zlsch|Zfbdt|Mwskz|Zbd1t|Wmwst1Fees|Bktxt|RmwwrFees'.
    ls_data-fieldnum = ''.
    ls_data-fielddat = ''.
    ls_data-fieldkey = ''.
